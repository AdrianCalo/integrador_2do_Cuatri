...
export default class Alumno extends Persona {
    ...
    constructor(nombre:string,apellido:string,dni:number,domicilio:string,fecha_nacimiento:string,matriculaID:number,curso:string,contactoEmergencia:number){
